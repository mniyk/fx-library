...
class TestBacktest:
    ...
    def test_order(self, direction, expect_order_data):
        ...
        self.back.order(data, direction)
    
        assert self.back.orders[ask_bid][0] == expect_order_data 
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                backtest.Settlement(open_price=100.000, high_price=100.150, low_price=100.050, spread=0.003),
                True, 
                -12.8,
                99.128, 
                100.000],
            [
                backtest.Settlement(open_price=100.150, high_price=100.150, low_price=100.050, spread=0.003),
                True, 
                2.2,
                99.128, 
                100.150],
            [
                ...
                0],
            [
                backtest.Settlement(open_price=100.000, high_price=101.150, low_price=99.050, spread=0.003),
                False, 
                -100,
                99.128, 
                99.050],
            [
                backtest.Settlement(open_price=100.000, high_price=101.150, low_price=100.050, spread=0.003),
                False, 
                100,
                99.128, 
                101.150]])
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                ...
                101.153],
            [
                backtest.Settlement(open_price=100.000, high_price=100.150, low_price=99.050, spread=0.003),
                False, 
                100,
                101.125, 
                99.053]])
...
class TestPerformance:
    def setup_method(self, method):
        ...
        self.performance = backtest.Performance(self.df, PARAMETER)
